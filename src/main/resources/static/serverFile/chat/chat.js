layui.use('layim', function(layim){
    ...
    layim.config({
        init: {
            ...
            mine: {
                ...
                ,"avatar": "http://222.222.216.162:10247/chat/picture/yonghu.png"
            }
            ,friend: []
            ,group: []
        },
    ...
    layim.chat({
        name: '在线咨询'
        ,type: 'robot'
        ,avatar: 'http://222.222.216.162:10247/chat/picture/xiaoyue.png'
        ,id: 1111
    });
    layim.setChatMin();
    var $ = layui.jquery;
    ...
    $('#mytempid').on('click', function(){
        ...
        obj2 = {
            ...
            ,id: 1111
            ,type: "robot"
            ,content: "img[http://222.222.216.162:10247/chat/picture/ewm.png]"
        }
